<?php /* Smarty version Smarty-3.1.21, created on 2018-06-11 09:51:53
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\common\mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1357861235b1e1c0971ed39-87191019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1357861235b1e1c0971ed39-87191019',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1e1c09883261_21639452',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1e1c09883261_21639452')) {function content_5b1e1c09883261_21639452($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.inline_script.php';
    ...
    <div class="title pull-left">
        <?php if (isset($_smarty_tpl->tpl_vars['title_start']->value)&&isset($_smarty_tpl->tpl_vars['title_end']->value)) {?>
            <h2 class="title__heading"
                title="<?php echo htmlspecialchars(preg_replace('!\s+!u', ' ',preg_replace('!<[^>]*?>!', ' ', (($tmp = @$_smarty_tpl->tpl_vars['title_alt']->value)===null||$tmp==='' ? ((string)$_smarty_tpl->tpl_vars['title_start']->value)." ".((string)$_smarty_tpl->tpl_vars['title_end']->value) : $tmp))), ENT_QUOTES, 'UTF-8');?>
"
            >
...
<span>
        ...
        <?php } else { ?>
            <h2 class="title__heading" title="<?php echo htmlspecialchars(preg_replace('!\s+!u', ' ',preg_replace('!<[^>]*?>!', ' ', (($tmp = @$_smarty_tpl->tpl_vars['title_alt']->value)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['title']->value : $tmp))), ENT_QUOTES, 'UTF-8');?>
