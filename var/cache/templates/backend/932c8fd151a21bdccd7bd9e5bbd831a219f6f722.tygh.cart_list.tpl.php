<?php /* Smarty version Smarty-3.1.21, created on 2018-06-14 08:32:34
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\cart\cart_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7993382375b21c5b2e00e28-24926826%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '932c8fd151a21bdccd7bd9e5bbd831a219f6f722' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\cart\\cart_list.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7993382375b21c5b2e00e28-24926826',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b21c5b30e3d63_65955073',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b21c5b30e3d63_65955073')) {function content_5b21c5b30e3d63_65955073($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
fn_preload_lang_vars(array('expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','customer','date','cart_content','ip','order_id','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','unregistered_customer','product_s','product','quantity','price','deleted_product','total','user_info','email','first_name','last_name','billing_address','first_name','last_name','address','address_2','city','state','country','zip_postal_code','shipping_address','first_name','last_name','address','address_2','city','state','country','zip_postal_code','no_data','delete_all_found','users_carts'));
?>
...
" class="hidden hand cm-combinations-carts"/><span class="icon-caret-down"></span></span>
        <span id="on_carts" alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" class="cm-combinations-carts"><span class="icon-caret-right"></span></span>
...
" data-ca-target-id="pagination_contents"><?php echo $_smarty_tpl->__("date");?>
    ...
    <th width="10%"><?php echo $_smarty_tpl->__("order_id");?>
</th>
...
}?></a><?php if ($_smarty_tpl->tpl_vars['customer']->value['phone']) {?><br /><?php echo $_smarty_tpl->__('phone');?>
 <bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['phone'], ENT_QUOTES, 'UTF-8');?>
</bdi><?php }
} else {
echo $_smarty_tpl->__("unregistered_customer");?>
 <?php if ($_smarty_tpl->tpl_vars['customer']->value['lastname']||$_smarty_tpl->tpl_vars['customer']->value['firstname']) {?><p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['customer']->value['email']) {?>(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['email'], ENT_QUOTES, 'UTF-8');?>
)<?php }
if ($_smarty_tpl->tpl_vars['customer']->value['phone']) {?><br /><?php echo $_smarty_tpl->__('phone');?>
 ...
 <?php echo $_smarty_tpl->__("product_s");?>
    ...
    <td><?php if ($_smarty_tpl->tpl_vars['customer']->value['order_id']) {?><a href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['customer']->value['order_id'])), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
</a><?php }?></td>
...
:</span></td>
                <td class="center"><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['cart_products'], ENT_QUOTES, 'UTF-8');?>
</span></td>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['carts_list']->value) {?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"delete",'text'=>$_smarty_tpl->__("delete_all_found"),'dispatch'=>"dispatch[cart.m_delete_all]",'form'=>"carts_list_form",'class'=>"cm-confirm cm-submit"));?>
</li>
