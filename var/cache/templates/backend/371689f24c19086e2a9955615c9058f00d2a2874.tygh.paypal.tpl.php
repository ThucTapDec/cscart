<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 15:40:50
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\addons\paypal\views\payments\components\cc_processors\paypal.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2066938285b1f8712362e35-11351170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '371689f24c19086e2a9955615c9058f00d2a2874' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\addons\\paypal\\views\\payments\\components\\cc_processors\\paypal.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2066938285b1f8712362e35-11351170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f871251ca13_20386312',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f871251ca13_20386312')) {function content_5b1f871251ca13_20386312($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.inline_script.php';
?><?php
fn_preload_lang_vars(array('currency','order_prefix','addons.paypal.status_for_new_orders','ttc_addons.paypal.status_for_new_orders','open','incompleted','addons.paypal.status_for_new_orders.open','addons.paypal.status_for_new_orders.incomplete','addons.paypal.technical_details','account','paypal_item_name','test_live_mode','test','live'));
?>
<?php $_smarty_tpl->tpl_vars["paypal_currencies"] = new Smarty_variable(fn_paypal_get_currencies("standard"), null, 0);?>
...
:</label>
    <div class="controls">
        <select name="payment_data[processor_params][new_order_status]" id="elm_new_order_status">
            ...
            <option value="<?php echo htmlspecialchars(@constant('STATUS_INCOMPLETED_ORDER'), ENT_QUOTES, 'UTF-8');?>
