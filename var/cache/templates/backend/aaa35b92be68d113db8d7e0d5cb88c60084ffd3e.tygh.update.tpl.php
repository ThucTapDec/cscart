<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 11:30:45
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\profiles\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10940822205b1f4c7529a5a2-97014888%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aaa35b92be68d113db8d7e0d5cb88c60084ffd3e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\profiles\\update.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10940822205b1f4c7529a5a2-97014888',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f4c7541a247_10922731',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f4c7541a247_10922731')) {function content_5b1f4c7541a247_10922731($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
?><?php
fn_preload_lang_vars(array('contact_information','user_profile_info','text_multiprofile_notice','billing_address','shipping_address','shipping_address','usergroup','status','no_data','allow_api_access','api_key','new_profile','editing_profile','view_all_orders','act_on_behalf','delete','create','notify_user'));
?>
...
<?php } else { ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['user_data']->value['firstname']) {?>
        <?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['user_data']->value['firstname'])." ".((string)$_smarty_tpl->tpl_vars['user_data']->value['lastname']), null, 0);?>
    <?php } elseif ($_smarty_tpl->tpl_vars['user_data']->value['b_firstname']) {?>
        <?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['user_data']->value['b_firstname'])." ".((string)$_smarty_tpl->tpl_vars['user_data']->value['b_lastname']), null, 0);?>
    <?php } else { ?>
        <?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['user_data']->value['email']), null, 0);?>
    <?php }?>
<?php }?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title_start'=>$_smarty_tpl->tpl_vars['title_start']->value,'title_end'=>$_smarty_tpl->tpl_vars['_title']->value,'title'=>$_smarty_tpl->tpl_vars['_title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
