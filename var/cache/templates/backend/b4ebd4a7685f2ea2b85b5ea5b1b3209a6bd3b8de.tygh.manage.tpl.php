...
<?php /*%%SmartyHeaderCode:11422008855b21ce430580a2-55980809%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '11422008855b21ce430580a2-55980809',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b21ce43238337_96750908',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b21ce43238337_96750908')) {function content_5b21ce43238337_96750908($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
fn_preload_lang_vars(array('text_admin_new_orders','incompleted_orders','orders','id','status','date','customer','phone','total','order','invoice','credit_memo','view','edit','copy','delete','no_data','for_this_page_orders','gross_total','totally_paid','for_all_found_orders','gross_total','totally_paid','add_order','view_all_orders','incompleted_orders','bulk_print_invoice','bulk_print_pdf','bulk_print_packing_slip','view_purchased_products','export_selected'));
?>
...
" class="underlined"><?php echo $_smarty_tpl->__("order");?>
 ...
 #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['credit_memo_id'], ENT_QUOTES, 'UTF-8');?>
    ...
    <td class="nowrap"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['o']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
</td>
    <td>
...
if ($_smarty_tpl->tpl_vars['o']->value['user_id']) {?></a><?php }?>
    ...
    <td><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></td>
