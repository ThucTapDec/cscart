<?php /* Smarty version Smarty-3.1.21, created on 2018-06-11 11:01:58
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\addons\components\addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9780560955b1e2c761085b2-23977093%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9780560955b1e2c761085b2-23977093',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1e2c761bff59_17484933',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1e2c761bff59_17484933')) {function content_5b1e2c761bff59_17484933($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
fn_preload_lang_vars(array('manage','settings','version','settings','licensing_and_upgrades','licensing_and_upgrades','uninstall','refresh','install','installed','no_data'));
?>
...
installed"<?php }?>><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php }?>
                <?php } else { ?>
                    <span class="row-status block"><bdi><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'UTF-8');?>
</bdi></span>
                <?php }?>
                    <br><span class="row-status object-group-details"><bdi><?php echo $_smarty_tpl->tpl_vars['a']->value['description'];?>
</bdi></span>
