<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 05:14:36
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\companies\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5937481125b1f2c8cae1473-96958598%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5937481125b1f2c8cae1473-96958598',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f2c8ce63817_84290090',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f2c8ce63817_84290090')) {function content_5b1f2c8ce63817_84290090($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.split.php';
...
:</label>
    <div class="controls">
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        https://<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'UTF-8');?>

    <?php } else { ?>
        <input type="text" name="company_data[secure_storefront]" id="elm_company_secure_storefront" size="32" value="<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'UTF-8');?>
...
<div class="sidebar-row sidebar-vendor-statistics">
    ...
    <ul class="unstyled">
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:accounting_sidebar_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:accounting_sidebar_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("companies.balance?vendor=".((string)$_smarty_tpl->tpl_vars['id']->value)."&selected_section=withdrawals"), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['company_data']->value['balance']), 0);?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("orders.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['orders_count'], ENT_QUOTES, 'UTF-8');?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("orders.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&is_search=Y&period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['company_data']->value['sales']), 0);?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("companies.balance?vendor=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['company_data']->value['income']), 0);?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("products.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&selected_section=withdrawals"), ENT_QUOTES, 'UTF-8');?>
