<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 07:21:54
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\addons\hybrid_auth\views\hybrid_auth\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4741710165b1f4a62ad3ac7-48057541%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7a34fc1184e0dca781c3122120ddd3aadf625d1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\addons\\hybrid_auth\\views\\hybrid_auth\\manage.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4741710165b1f4a62ad3ac7-48057541',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f4a62b69d03_52117942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f4a62b69d03_52117942')) {function content_5b1f4a62b69d03_52117942($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.script.php';
?><?php
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>$_smarty_tpl->tpl_vars['provider_data']->value['provider_id'],'text'=>(($tmp = @$_smarty_tpl->tpl_vars['providers_schema']->value[$_smarty_tpl->tpl_vars['provider_data']->value['provider']]['provider'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['provider_data']->value['provider'] : $tmp),'href'=>"hybrid_auth.update?provider=".((string)$_smarty_tpl->tpl_vars['provider_data']->value['provider']),'href_delete'=>"hybrid_auth.delete_provider?provider=".((string)$_smarty_tpl->tpl_vars['provider_data']->value['provider']),'table'=>"hybrid_auth_providers",'object_id_name'=>"provider_id",'delete_target_id'=>"manage_providers_list,content_group_*",'status'=>$_smarty_tpl->tpl_vars['provider_data']->value['status'],'additional_class'=>"cm-sortable-row cm-sortable-id-".((string)$_smarty_tpl->tpl_vars['provider_data']->value['provider_id']),'no_table'=>true,'is_view_link'=>false,'header_text'=>$_tmp1.": ".((string)$_smarty_tpl->tpl_vars['providers_schema']->value[$_smarty_tpl->tpl_vars['provider_data']->value['provider']]['provider']),'draggable'=>true), 0);?>
