...
<?php /*%%SmartyHeaderCode:17637071065b1e1c07c3ca74-54184030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17637071065b1e1c07c3ca74-54184030',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5b1e1c07ed9f87_17664046',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1e1c07ed9f87_17664046')) {function content_5b1e1c07ed9f87_17664046($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.script.php';
...
"><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['orders_stat']->value['orders']), ENT_QUOTES, 'UTF-8');?>
                                ...
                                <bdi><?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['orders_stat']->value['prev_orders']), ENT_QUOTES, 'UTF-8');?>
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['orders_stat']->value['orders_total'])) {?>
                    <td>
                        <div class="dashboard-card">
                            ...
                            <div class="dashboard-card-content">
                                <h3><a href="<?php echo htmlspecialchars(fn_url("orders.manage?is_search=Y&period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['orders_stat']->value['orders_total']['totally_paid']), 0);?>
</a></h3><bdi><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['orders_stat']->value['prev_orders_total']['totally_paid']), 0);?>
                    ...
                    <td>
                        <div class="dashboard-card">
                            ...
                            <div class="dashboard-card-content">
                                ...
                                <bdi><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['orders_stat']->value['taxes']['prev_subtotal']), 0);?>
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['orders_stat']->value['abandoned_cart_total'])) {?>
                    <td>
                        <div class="dashboard-card">
                            ...
                            <div class="dashboard-card-content">
                                <h3><a href="<?php echo htmlspecialchars(fn_url("cart.cart_list"), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['orders_stat']->value['abandoned_cart_total'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'UTF-8');?>
</a></h3><bdi><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['orders_stat']->value['prev_abandoned_cart_total'])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'UTF-8');?>
...
"><span><?php echo $_smarty_tpl->__("order");?>
</span>&nbsp;<bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['order'], ENT_QUOTES, 'UTF-8');?>
</bdi></a><br>
...
"><bdi>&lrm; <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['category'], ENT_QUOTES, 'UTF-8');?>
</bdi></a><br>
                                <?php }?>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"index:recent_activity_item"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                                ...
                                <span class="date"><bdi><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
</bdi></span>
