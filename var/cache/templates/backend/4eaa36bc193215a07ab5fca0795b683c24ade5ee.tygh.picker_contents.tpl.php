<?php /* Smarty version Smarty-3.1.21, created on 2018-06-13 11:23:21
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\pickers\users\picker_contents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2296607535b209c39230777-05155006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4eaa36bc193215a07ab5fca0795b683c24ade5ee' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\pickers\\users\\picker_contents.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2296607535b209c39230777-05155006',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b209c39362fa2_14207474',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b209c39362fa2_14207474')) {function content_5b209c39362fa2_14207474($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.inline_script.php';
...
?><?php
fn_preload_lang_vars(array('text_items_added','id','email','person_name','registered','type','active','administrator','vendor_administrator','customer','affiliate','disable','active','no_data','choose','add_users_and_close','add_users'));
?>
...
" />
    ...
    <td><span class="user-name"><?php if ($_smarty_tpl->tpl_vars['user']->value['firstname']||$_smarty_tpl->tpl_vars['user']->value['lastname']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['lastname'], ENT_QUOTES, 'UTF-8');
    ...
    <td><?php if ($_smarty_tpl->tpl_vars['user']->value['user_type']=="A") {
...
echo $_smarty_tpl->__("affiliate");
    ...
    <td class="right"><?php if ($_smarty_tpl->tpl_vars['user']->value['status']=="D") {
