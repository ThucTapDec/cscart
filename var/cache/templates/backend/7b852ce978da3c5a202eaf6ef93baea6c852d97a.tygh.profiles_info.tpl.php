<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 13:08:07
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\order_management\components\profiles_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1580259645b1f63472111c5-94766167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b852ce978da3c5a202eaf6ef93baea6c852d97a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\order_management\\components\\profiles_info.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1580259645b1f63472111c5-94766167',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5b1f63473b1a67_31162464',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f63473b1a67_31162464')) {function content_5b1f63473b1a67_31162464($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\block.hook.php';
?><?php
...
if ($_smarty_tpl->tpl_vars['user_data']->value['b_city']&&($_smarty_tpl->tpl_vars['user_data']->value['b_state_descr']||$_smarty_tpl->tpl_vars['user_data']->value['b_zipcode'])) {?>,<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['b_state_descr'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['b_zipcode'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['user_data']->value['b_phone']) {?>
                <p><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['b_phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></p>
            <?php }?>
        <?php } else { ?>
...
if ($_smarty_tpl->tpl_vars['user_data']->value['s_city']&&($_smarty_tpl->tpl_vars['user_data']->value['s_state_descr']||$_smarty_tpl->tpl_vars['user_data']->value['s_zipcode'])) {?>,<?php }?>  <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['s_state_descr'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['s_zipcode'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['user_data']->value['s_phone']) {?>
                <p><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['s_phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></p>
            <?php }?>
...
:</span>
                <span><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></span>
            <?php }?>
