<?php /* Smarty version Smarty-3.1.21, created on 2018-06-12 14:19:02
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\statuses\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13978147215b1f73e6a7c980-49898991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f08ee326fd675c4f211b0c0fd75808913919de8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\statuses\\manage.tpl',
      1 => 1525668008,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13978147215b1f73e6a7c980-49898991',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f73e6be27b7_14551614',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f73e6be27b7_14551614')) {function content_5b1f73e6be27b7_14551614($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\function.script.php';
...
?><?php
fn_preload_lang_vars(array('edit_customer_notification','edit_admin_notification','editing_status','no_data','new_status','add_status','add_status','unable_to_create_status','maximum_number_of_statuses_reached'));
?>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"statuses:list_extra_links"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['type']->value==@constant('STATUSES_ORDER')) {?>
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>mb_strtolower($_smarty_tpl->tpl_vars['s']->value['status'], 'UTF-8'),'text'=>$_smarty_tpl->tpl_vars['s']->value['description'],'href'=>"statuses.update?status=".((string)$_smarty_tpl->tpl_vars['s']->value['status'])."&type=".((string)$_smarty_tpl->tpl_vars['type']->value),'href_delete'=>$_smarty_tpl->tpl_vars['cur_href_delete']->value,'delete_target_id'=>"statuses_list,actions_panel",'header_text'=>$_tmp1.": ".((string)$_smarty_tpl->tpl_vars['s']->value['description']),'additional_class'=>"cm-sortable-row cm-sortable-id-".((string)$_smarty_tpl->tpl_vars['s']->value['status_id']),'table'=>"statuses",'object_id_name'=>"status_id",'no_table'=>true,'draggable'=>$_smarty_tpl->tpl_vars['ability_sorting']->value,'nostatus'=>true,'tool_items'=>Smarty::$_smarty_vars['capture']['tool_items'],'extra_data'=>Smarty::$_smarty_vars['capture']['extra_data']), 0);?>
